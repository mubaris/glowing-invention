...
contract UniswapResolver is UniswapLiquidity {
    ...
    */
    ...
    function buyViaPath(
        ...
        convertEthToWeth(_sellAddr, expectedSellAmt);
        _sellAddr.approve(address(router), expectedSellAmt);
    ...
    function sellViaPath(
        ...
        if (sellAmt == uint(-1)) {
            sellAmt = sellAddr == getEthAddr() ? address(this).balance : _sellAddr.balanceOf(address(this));
        }
